...
content1[0]=`<img src=" tour.jpg" class="d-block w-100 " alt="..."> `;
content1[1]=`<img src="truck.jpg" class="d-block w-100" alt="..." >  `;
content1[2]=`<img src="roadtrip.jpg" class="d-block w-100" alt="..."> `;
let cnt=0;
